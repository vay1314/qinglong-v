...
update_qinglong() {
    ...
    reset_romote_url ${dir_root} "${github_proxy_url}https://github.com/vay1314/qinglong-v.git"
    ...
    local url="${github_proxy_url}https://github.com/vay1314/qinglong-v-static.git"
